  ...
  return (
    <div style={{ textAlign: "center", backgroundColor: backgroundColor, minHeight: "100vh", overflow: "hidden" }}>
      ...
      <Drawer anchor="left" open={sidebarOpen} onClose={toggleSidebar}>
        ...
        >
          <UserProfile id="userprofile"><img  id="userimage" width="60px" height="60px"  src="https://cdn.pixabay.com/photo/2019/10/10/18/51/smartphone-4540273_1280.jpg" alt="User"></img> </UserProfile>
          <List>
